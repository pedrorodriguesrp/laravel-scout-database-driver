...
class DbugitSearchEngineTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_update_adds_objects_to_index()
    {
        ...
        // $engine = new DbugitSearchEngine($client);
        // $engine->update(Collection::make([new DbugitSearchEngineTestModel()]));
    }
}

class DbugitSearchEngineTestModel
{
